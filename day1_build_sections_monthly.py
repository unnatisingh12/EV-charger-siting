...
Reads  : data/raw/tg_ev_monthly_master.csv   (never modified)
Writes : data/processed/sections_monthly.csv
         data/processed/negative_rows_removed.csv
...
RAW = ROOT / "data" / "raw" / "tg_ev_monthly_master.csv"
