...
Reads  : sections_geocoded_combined_raw.csv (first run + retry, in this day2 folder)
         ../sections_monthly.csv (Day 1 file, on the main page of the repository)
...
monthly = pd.read_csv(HERE.parent / "sections_monthly.csv")   # Day 1 file, on the main page of the repository
